...
function fillProjectEntites()
{
	...
	$projectEntities[ "flow_disposisi" ] = array( "url" => "flow_disposisi", "type" => 6 );
	$projectEntitiesReverse[ "flow_disposisi" ] = "flow_disposisi";
	...
	$projectEntities[ "m_room_meeting" ] = array( "url" => "m_room_meeting", "type" => 0 );
	$projectEntitiesReverse[ "m_room_meeting" ] = "m_room_meeting";
	$projectEntities[ "ListRoom" ] = array( "url" => "listroom", "type" => 6 );
	$projectEntitiesReverse[ "listroom" ] = "ListRoom";
	$projectEntities[ "t_booking_view" ] = array( "url" => "t_booking_view", "type" => 1 );
	$projectEntitiesReverse[ "t_booking_view" ] = "t_booking_view";
	$projectEntities[ "m_disposition_view" ] = array( "url" => "m_disposition_view", "type" => 1 );
	$projectEntitiesReverse[ "m_disposition_view" ] = "m_disposition_view";
	$projectEntities[ "m_login" ] = array( "url" => "m_login", "type" => 0 );
	$projectEntitiesReverse[ "m_login" ] = "m_login";
	$projectEntities[ "m_login1" ] = array( "url" => "m_login1", "type" => 1 );
	$projectEntitiesReverse[ "m_login1" ] = "m_login1";
	$projectEntities[ "m_login2" ] = array( "url" => "m_login2", "type" => 1 );
	$projectEntitiesReverse[ "m_login2" ] = "m_login2";
	$projectEntities[ "m_login3" ] = array( "url" => "m_login3", "type" => 1 );
	$projectEntitiesReverse[ "m_login3" ] = "m_login3";
	$projectEntities[ "m_employee1" ] = array( "url" => "m_employee1", "type" => 1 );
	$projectEntitiesReverse[ "m_employee1" ] = "m_employee1";
	$projectEntities[ "m_employee2" ] = array( "url" => "m_employee2", "type" => 1 );
	$projectEntitiesReverse[ "m_employee2" ] = "m_employee2";
	$projectEntities[ "m_employee3" ] = array( "url" => "m_employee3", "type" => 1 );
	$projectEntitiesReverse[ "m_employee3" ] = "m_employee3";
	$projectEntities[ "m_employee4" ] = array( "url" => "m_employee4", "type" => 1 );
