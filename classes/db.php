	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "u736239518tsundbat154412412" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "m_room_meeting", "varname" => "u736239518tsundbat154412412__tblm_room_meeting", "altvarname" => "tblm_room_meeting", "connId" => "u736239518tsundbat154412412", "schema" => "", "connName" => "u736239518_tsundb at 154.41.24");
