...
$tdatam_login[".pagesByType"] = my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"]}" );
$tdatam_login[".originalPagesByType"] = $tdatam_login[".pagesByType"];
$tdatam_login[".pages"] = types2pages( my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"]}" ) );
$tdatam_login[".originalPages"] = $tdatam_login[".pages"];
$tdatam_login[".defaultPages"] = my_json_decode( "{\"list\":\"list\",\"search\":\"search\"}" );
...
if(mlang_getcurrentlang()=="English")
{
	...
	$placeHoldersm_login["English"]["username"] = "";
	...
	$fieldLabelsm_login["English"]["m_employee_id"] = "M Employee Id";
...
$tdatam_login[".googleLikeFields"][] = "two_factor";
$tdatam_login[".googleLikeFields"][] = "totp";
$tdatam_login[".googleLikeFields"][] = "reset_token";
$tdatam_login[".googleLikeFields"][] = "reset_date";
$tdatam_login[".googleLikeFields"][] = "phone";
