...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelst_booking["English"]["t_booking_status"] = "Booking Status";
...
if( $pages[PAGE_EDIT] ) {
	...
	$tdatat_booking[".afterEditAction"] = 5;
	$tdatat_booking[".closePopupAfterEdit"] = 1;
	$tdatat_booking[".afterEditActionDetTable"] = "m_disposition";
}

if( $pages[PAGE_ADD] ) {
$tdatat_booking[".add"] = true;
$tdatat_booking[".afterAddAction"] = 3;
$tdatat_booking[".closePopupAfterAdd"] = 0;
...
$tdatat_booking[".isUseTimeForSearch"] = true;


$tdatat_booking[".badgeColor"] = "B22222";
...
//	m_vehicle
		...
		$dIndex = 1;
	$detailsParam = array();
	$detailsParam["dDataSourceTable"]="m_vehicle";
		$detailsParam["dOriginalTable"] = "m_vehicle";



		
		$detailsParam["dType"]=PAGE_LIST;
	$detailsParam["dShortTable"] = "m_vehicle";
	$detailsParam["dCaptionTable"] = GetTableCaption("m_vehicle");
	$detailsParam["masterKeys"] =array();
	$detailsParam["detailKeys"] =array();
	...
	$detailsTablesData["t_booking"][$dIndex]["masterKeys"][]="m_vehicle_driver";

				$detailsTablesData["t_booking"][$dIndex]["detailKeys"] = array();

	$detailsTablesData["t_booking"][$dIndex]["detailKeys"][]="m_vehicle_driver";
//endif
