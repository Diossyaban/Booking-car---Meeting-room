...
$tdatam_disposition[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatam_disposition[".originalPagesByType"] = $tdatam_disposition[".pagesByType"];
$tdatam_disposition[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatam_disposition[".originalPages"] = $tdatam_disposition[".pages"];
$tdatam_disposition[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"export\":\"export\",\"import\":\"import\",\"list\":\"list\",\"print\":\"print\",\"search\":\"search\",\"view\":\"view\"}" );
...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelsm_disposition["English"]["t_disposition_to_date"] = "Disposition To Date";
	...
	$fieldLabelsm_disposition["English"]["t_disposition_no_doc"] = "Disposition No Doc";
...
$tdatam_disposition[".afterAddActionDetTable"] = "Detail tables not found!";
}
...
$tdatam_disposition[".badgeColor"] = "f8a447";
...
$tdatam_disposition[".arrGridTabs"] = $arrGridTabs;
...
// Begin Lookup settings
				$edata["LookupType"] = 2;
	$edata["LookupTable"] = "flow_disposisi";
...
$masterTablesData["m_disposition"] = array();
	...
	//if !@t.bReportCrossTab
			$strOriginalDetailsTable="t_booking";
	$masterParams = array();
	$masterParams["mDataSourceTable"]="t_booking_view";
	$masterParams["mOriginalTable"]= $strOriginalDetailsTable;
	$masterParams["mShortTable"]= "t_booking_view";
	$masterParams["masterKeys"]= array();
	$masterParams["detailKeys"]= array();
