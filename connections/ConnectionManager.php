...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data["connectionString"] = "mysql;192.168.0.5;admin;root;3308;tsundb2;;1"; //currently unused
		...
		$data["connInfo"][0] = "192.168.0.5";
		$data["connInfo"][1] = "admin";
		$data["connInfo"][2] = "root";
		$data["connInfo"][3] = "3308";
		$data["connInfo"][4] = "tsundb2";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=192.168.0.5;Uid=admin;Pwd=root;Port=3308;Database=tsundb2;OPTION=3";
		// encription set
